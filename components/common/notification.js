...
const loadingNotification = (config) => {
    config['icon'] = <svg class="animate-spin icon-base text-yellow-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
const mergeConfig = (config) => {
    let cfg = {
        ...
        'duration' : config.duration ? config.duration : 5,
