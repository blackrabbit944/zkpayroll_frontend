...
import DuringTimeSelect from 'components/form/during_time_select'
...
import {addSteamingSalary,updateSteamingSalary} from 'redux/reducer/steaming_salary'
...
class SalaryAdd extends React.Component {
    ...
    setForm(salary = null) {
        ...
        if (!salary) {
            ...
            this.formRef.current.setValues({
                ...
                'during_time'       : salary.get('during_time'),
    ...
    render() {
        ...
        const salaryFormSchema = Yup.object().shape({
            ...
            during_time      : Yup.number().required(),
                    ...
                    <Formik
                        ...
                        {({ errors, touched }) => (
                            ...
                            <div className="p-4 md:p-6">
                                ...
                                <DuringTimeSelect name="during_time" label={t("during time")}/>                                
...
const mapDispatchToProps = (dispatch) => {
     return {
        addSalary : (data) => {
            return dispatch(addSteamingSalary(data))
        },
        updateSalary : (id,data) => {
            return dispatch(updateSteamingSalary(id,data))
        },
     }
}
