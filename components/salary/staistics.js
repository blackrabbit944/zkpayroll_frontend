...
import {salaryListSchema,userSchema} from 'redux/schema/index'
...
function mapStateToProps(state,ownProps) {
   ...
   let list_data = state.getIn(['salary','list','d41d8cd98f00b204e9800998ecf8427e']);
   if (!list_data) {
       list_data = defaultListData
   }
   let list_rows = denormalize(list_data.get('list'),salaryListSchema,entities)
