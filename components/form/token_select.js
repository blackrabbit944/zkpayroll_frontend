...
class TokenSelect extends React.Component {
    ...
    render() {
        ...
        let default_tokens = getConfig('SALARY_TOKEN_LIST');
        ...
        return  <div className="form-control">
            ...
            {({
               ...
               meta,
                ...
                const select_contract_name = (default_tokens[value]) ? default_tokens[value].toUpperCase() : '';
                ...
                let menu = <div className="block-menu shadow-xl">
                    <ul className="overflow-y-auto w-full bg-white py-2 border-gray-200 border">
                        {
                            Object.keys(default_tokens).map(addr=>{
                                return <li key={addr} >
                                    ...
                                    <div className="">
                                        {default_tokens[addr].toUpperCase()}    
                                    </div>
                                    </a>
                                </li>
                            })
